<?php
	...
	class DashboardModel extends CI_Model {
		...
		{
			$this->db->select("b.booking_id,b.order_no,b.is_demo,b.admin_demo_accept,b.user_id,b.service_group_id,b.service_group_assigned,c.category_id,c.category_name,c.category_image,u.profile_id,u.profile_pic,u.full_name,u.mobile,u.email,b.booking_date,b.time_slot,b.expiry_date,b.duration,b.booking_status,b.service_provider_id
		...
		{
			/*************** Ongoing ************************** */
            $ongoing_bookings=$this->getAllBookings($user_id,'waiting',1);
			...
			// Completed
			/*************** Ongoing ************************** */
            $ongoing_bookings=$this->getAllBookings($user_id,'ongoing',1);
            $ongoingbooking_ids="(-1";
            foreach($ongoing_bookings as $booking)
            {
                if($booking['service_group_assigned']=='YES')

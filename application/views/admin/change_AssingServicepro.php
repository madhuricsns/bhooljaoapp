                ...
                <div class="card tab2-card">
                    ...
                    <div class="card-body">
                      <?php if($this->session->flashdata('success')!=""){?>
						...
						<form class="needs-validation" name="frm_updatecity" id="frm_updatecity" method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>backend/Booking/changeAssingServiceProvider/<?php echo $encodedValueId;?>">

                            ...
                            <div class="tab-pane fade active show">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group row">
                                                <label for="minprice" class="col-xl-3 col-md-4"><span>*</span> Min-Price</label>
                                                <input type="text" name="minprice" id="minprice" class="form-control  col-md-6"required value="<?php echo $serviceInfo[0]['min_price'];?>">
                                            </div>
                                             <div class="form-group row">
                                                <label for="mobile_number" class="col-xl-3 col-md-4"><span>*</span> Max-Price</label>
                                                <input type="text" name="maxprice" id="maxprice" class="form-control  col-md-6"required value="<?php echo $serviceInfo[0]['max_price'];?>">
                                            </div>
